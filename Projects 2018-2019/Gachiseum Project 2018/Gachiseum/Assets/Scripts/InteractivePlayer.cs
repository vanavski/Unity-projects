            ...
            if (dist < max_dist)
            {
                switch (_collision)
                {
                    ...
                    case "Object":
                        Description obj;
                        ObjectController oc;
                        if (hit.gameObject.GetComponent<Description>() != null)
                        {
                            obj = hit.gameObject.GetComponent<Description>();
                            description.text = obj.Activation();
                        }
                        else
                        {
                            oc = hit.gameObject.GetComponent<ObjectController>();
                            description.text = oc.Description();
                        }
                        hit.gameObject.GetComponent<ObjectController>().Activate(playerTouch);
                        break;
